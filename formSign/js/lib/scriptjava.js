...
var _$$={
    ...
    $f:function (arg) {
        ...
        div.innerHTML = '<iframe style="width:250px;height:200px;" src="about:blank" id="'+id+'" name="'+id+'" onload="if(this.onsendcomplete) {if(this.contentDocument) {var d = this.contentDocument;}else if(this.contentWindow) {var d = this.contentWindow.document;}else {var d = window.frames[this.id].document;}if(d.location.href != \'about:blank\') {this.onsendcomplete(d);}}"></iframe>';
        div.style.display='none';

        _$$.$(id).onsendcomplete = function(responseDoc) { setTimeout(function () { _$$.$().body.removeChild(div); }, 60000); onsend(responseDoc); };
